...
#define MY_PATH filesystem::current_path().parent_path().u8string()
using namespace glm;
...
int main(){
	...
	//string mainPathString{mainPath.parent_path().u8string()};
	printf(MY_PATH.c_str());
	/* ----------------------- */
